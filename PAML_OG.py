...
def main(args):
	...
	# csep_og = "/Users/alexwang/0data/0mango/1_OrthoFinder/CSEP_Orthogroups.txt"

	CDS_PATH = args.CDSFILE
	alignment_PATH = args.ALNPATH
	csep_og = args.TARGET
...
if __name__ == '__main__':
	...
	parser.add_argument("-cds", "--cds", help="input all cds file for PAML", dest="CDSFILE")
	parser.add_argument("-aln_path", "--alignment path", help="input orthogroups alignment path", dest="ALNPATH")
	parser.add_argument("-subog", "--target_OG", help="subset of orthogroups.txt", dest="TARGET")
