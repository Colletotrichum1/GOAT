...
if __name__ == '__main__':
	...
	parser.add_argument("-pep", "--pep", help="input all protein file for PAML", dest="PEPFILE")
	parser.add_argument("-gene_id", "--gene_name", help="accessory gene id for PAML", dest="GENEID")
